...
bytecoder.imports["bytecoder"].resolveStringConstant = function(index) {
  switch(index) {
      ...
      case 286: return 'Illegal Capacity: ';
      case 287: return 'Illegal Load: ';
      case 288: return '(for control)';
      case 289: return '(for generator)';
      case 290: return '(for index)';
      case 291: return '(for limit)';
      case 292: return '(for state)';
      case 293: return '(for step)';
      case 294: return 'and';
      case 295: return 'break';
      case 296: return 'do';
      case 297: return 'else';
      case 298: return 'elseif';
      case 299: return 'end';
      case 300: return 'for';
      case 301: return 'goto';
      case 302: return 'if';
      case 303: return 'in';
      case 304: return 'not';
      case 305: return 'or';
      case 306: return 'repeat';
      case 307: return 'then';
      case 308: return 'until';
      case 309: return 'while';
      case 310: return '..';
      case 311: return '...';
      case 312: return '==';
      case 313: return '>=';
      ...
      case 316: return '::';
      case 317: return '<eos>';
      case 318: return '<number>';
      case 319: return '<name>';
      case 320: return '<string>';
      case 321: return '<eof>';
      case 322: return 'compiler assert failed';
      case 323: return 'upvalues';
      case 324: return 'main function has more than ';
      case 325: return '[string \"';
      case 326: return '\"]';
      case 327: return 'syntax error: ';
      case 328: return ' near ';
      case 329: return 'char(';
      case 330: return 'function at line ';
      case 331: return ' has more than ';
      case 332: return 'Ee';
      case 333: return 'Xx';
      case 334: return 'Pp';
      case 335: return '+-';
      case 336: return 'chunk has too many lines';
      case 337: return 'nesting of [[...]] is deprecated';
      case 338: return 'unfinished long string';
      case 339: return 'unfinished long comment';
      case 340: return 'invalid long string delimiter';
      case 341: return '.';
      case 342: return 'escape sequence too large';
      case 343: return 'hexadecimal digit expected \'x';
      case 344: return 'unfinished string';
      case 345: return 'chunk has too many syntax levels';
      case 346: return 'unexpected symbol ';
      case 347: return ' (';
      case 348: return ' expected';
      case 349: return 'control structure too long';
      case 350: return 'function or expression too complex';
      case 351: return 'cannot use ';
      case 352: return ' outside a vararg function';
      case 353: return 'self';
      case 354: return 'local variables';
      case 355: return '<name> or ';
      case 356: return ' expected ';
      case 357: return '(to close ';
      case 358: return ' at line ';
      case 359: return '<goto ';
      case 360: return '> at line ';
      case 361: return ' jumps into the scope of local \'';
      case 362: return '<';
      case 363: return ' not inside a loop';
      case 364: return 'no visible label \'';
      case 365: return '\' for <goto> at line ';
      case 366: return 'items in a constructor';
      case 367: return 'function arguments expected';
      case 368: return 'syntax error';
      case 369: return 'label \'';
      case 370: return ' already defined on line ';
      case 371: return ' or ';
      case 372: return 'Required array length ';
      case 373: return ' + ';
      case 374: return ' is too large';
      case 375: return ' instack ';
      case 376: return ' closed ';
      case 377: return 'start must be > 0';
      case 378: return 'bad argument #';
      case 379: return 'nan';
      case 380: return '-inf';
      case 381: return 'inf';
      case 382: return 'attempt to compare string with number';
      case 383: return 'abs';
      case 384: return 'ceil';
      case 385: return 'cos';
      case 386: return 'deg';
      case 387: return 'exp';
      case 388: return 'floor';
      case 389: return 'fmod';
      case 390: return 'frexp';
      case 391: return 'huge';
      case 392: return 'ldexp';
      case 393: return 'max';
      case 394: return 'min';
      case 395: return 'modf';
      case 396: return 'pi';
      case 397: return 'pow';
      case 398: return 'random';
      case 399: return 'randomseed';
      case 400: return 'rad';
      case 401: return 'sin';
      case 402: return 'sqrt';
      case 403: return 'tan';
      case 404: return 'math';
      case 405: return 'package';
      case 406: return 'loaded';
      case 407: return 'globals';
      case 408: return 'debug';
      case 409: return 'gethook';
      case 410: return 'getinfo';
      case 411: return 'getlocal';
      case 412: return 'getmetatable';
      case 413: return 'getregistry';
      case 414: return 'getupvalue';
      case 415: return 'getuservalue';
      case 416: return 'sethook';
      case 417: return 'setlocal';
      case 418: return 'setmetatable';
      case 419: return 'setupvalue';
      case 420: return 'setuservalue';
      case 421: return 'traceback';
      case 422: return 'upvalueid';
      case 423: return 'upvaluejoin';
      case 424: return 'attempt to compare number with string';
      case 425: return 'table index';
      case 426: return 'table or string';
      case 427: return 'Input length = ';
      case 428: return '; ';
      case 429: return '<dead';
      case 430: return 'String';
      case 431: return 'interval is empty';
      case 432: return 'c';
      case 433: return 'l';
      case 434: return 'r';
      case 435: return 'value expected';
      case 436: return 'index out of range';
      case 437: return 'flnStu';
      case 438: return 'function or level';
