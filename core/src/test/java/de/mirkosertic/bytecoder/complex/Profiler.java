...
public class Profiler {
    ...
    public static void main(final String[] args) throws NoSuchMethodException {
        ...
        while(true) {
            ...
            final CompileOptions theOptions = new CompileOptions(LOGGER, true, KnownOptimizer.ALL, true, "bytecoder", 512, 512, false, false, Allocator.passthru, new String[0], new String[0], null, false);
