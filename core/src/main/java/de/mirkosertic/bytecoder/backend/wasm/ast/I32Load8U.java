...
public class I32Load8U implements Expression {

    private final Alignment alignment;
    private final int offset;
    private final Value ptr;

    I32Load8U(final int offset, final Value ptr) {
        this(Alignment.ONE, offset, ptr);
    }

    I32Load8U(final Alignment alignment, final int offset, final Value ptr) {
