...
public class CompileOptions {
    ...
    private final boolean tryStackifierFirst;
    ...
    public CompileOptions(final Logger aLogger, final boolean aDebugOutput, final Optimizer aOptimizer, final boolean aEnableExceptions,
                          ...
                          final boolean aTryStackifierFirst) {
        logger = aLogger;
        ...
        minify = aMinify;
        tryStackifierFirst = aTryStackifierFirst;
    }
    ...
    public boolean isTryStackifierFirst() {
        return tryStackifierFirst;
    }
}
