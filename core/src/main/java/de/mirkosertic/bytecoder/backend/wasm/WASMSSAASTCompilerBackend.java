...
public class WASMSSAASTCompilerBackend implements CompileBackend<WASMCompileResult> {
    ...
    public WASMCompileResult generateCodeFor(
        ...
        try (final PrintWriter theWriter = new PrintWriter(theJSCode)) {
            ...
            theWriter.println("         },");
            theWriter.println("         cds: {");
            theWriter.println("             isDumpingClassList0: function() {return 0;},");
            theWriter.println("             isDumpingArchive0: function() {return 0;},");
            theWriter.println("             isSharingEnabled0: function() {return 0;},");
            theWriter.println("             initializeFromArchiveClass: function() {},");
            theWriter.println("             getRandomSeedForDumping: function() {return 0;},");
            theWriter.println("         },");
            ...
            theWriter.println("         },");
            theWriter.println("         scopedmemoryaccess: {");
            theWriter.println("             registerNatives: function() {},");
            theWriter.println("         },");
