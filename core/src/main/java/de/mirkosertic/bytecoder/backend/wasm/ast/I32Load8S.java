...
public class I32Load8S implements WASMExpression {
    ...
    I32Load8S(final int offset, final WASMValue ptr, final Expression expression) {
        this(Alignment.ONE, offset, ptr, expression);
    }

    I32Load8S(final Alignment alignment, final int offset, final WASMValue ptr, final Expression expression) {
    ...
    public void writeTo(final BinaryWriter.Writer codeWriter, final ExportContext context) throws IOException {
        ...
        codeWriter.writeByte((byte) 0x2c);
