...
public class GotoGraphBuilder {

    private final List<JumpArrow> knownJumpArrows;
    private final List<Integer> nodesInOrder;

    public GotoGraphBuilder(final List<Integer> nodesInOrder) {
    ...
    public GotoGraph build() {
        final GotoGraph stack = new GotoGraph(knownJumpArrows, nodesInOrder);
        stack.stackify();
        return stack;
    }
}
