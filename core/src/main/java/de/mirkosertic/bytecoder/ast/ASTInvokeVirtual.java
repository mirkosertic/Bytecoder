...
public class ASTInvokeVirtual extends ASTValue {

    private final ASTValue reference;
    private final List<ASTValue> arguments;
    private final BytecodeMethodRefConstant methodRef;

    public ASTInvokeVirtual(ASTValue aReference, List<ASTValue> aArguments, BytecodeMethodRefConstant aMethodRef) {
