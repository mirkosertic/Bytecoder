...
public class I32Load16S implements WASMExpression {
    ...
    I32Load16S(final int offset, final WASMValue ptr, final Expression expression) {
        this(Alignment.TWO, offset, ptr, expression);
    }

    I32Load16S(final Alignment alignment, final int offset, final WASMValue ptr, final Expression expression) {
