...
public class GetReflectiveFieldExpression extends Expression {

    private final TypeRef resolvedType;

    public GetReflectiveFieldExpression(final Program program, final BytecodeOpcodeAddress address,
